...
export default defineConfig({
  resolve: {
    alias: {
      ...
      '@vitamin/schema': resolve(__dirname, 'packages/schema/src/index.ts'),
      ...
      '@vitamin/manifest': resolve(__dirname, 'packages/manifest/src/index.ts'),
      '@vitamin/prompt': resolve(__dirname, 'packages/prompt/src/index.ts'),
      ...
      '@vitamin/protocol': resolve(__dirname, 'packages/protocol/src/index.ts'),
