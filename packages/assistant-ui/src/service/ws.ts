...
export type WebSocketEventHandle = (message: WebSocketMessage) => void
...
class WebSocketClient {
  ...
  private handlers: Map<string, Set<WebSocketEventHandle>> = new Map()
  ...
  on(eventType: string, handler: WebSocketEventHandle) {
