...
export function Slider({
  ...
  return (
    <BaseSlider.Root
      ...
      name={name}
      thumbAlignment="edge"
      className={clsx(sliderRootClassName, className)}
    >
