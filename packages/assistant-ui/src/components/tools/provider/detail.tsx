...
import { LinkExternal02, Settings01 } from '@/components/icons/src/vender/line/general'
...
const ProviderDetail = ({
  ...
  return (
    <Drawer
      ...
      panelClassName={clsx('mb-2 mr-2 mt-[64px] w-[420px]! max-w-[420px]! justify-start rounded-2xl border-[0.5px] border-components-panel-border bg-components-panel-bg! p-0! shadow-xl')}
    >
      <div className="flex h-full flex-col p-4">
        ...
        <div className="flex gap-1 border-b-[0.5px] border-divider-subtle">
          {collection.type === CollectionType.custom && !isDetailLoading && (
            <Button
              className={clsx('my-3 w-full shrink-0')}
          ...
          {collection.type === CollectionType.workflow && !isDetailLoading && customCollection && (
            <>
              <Button
                variant="primary"
                className={clsx('my-3 w-[183px] shrink-0')}
              >
