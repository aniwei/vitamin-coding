...
import AlertTriangle from '@/components/icons/solid/alertsAndFeedback/AlertTriangle'
...
const AuthenticationSection: FC<AuthenticationSectionProps> = ({
  ...
  return (
    <>
      ...
      <div>
        <div className={clsx('mb-1 flex h-6 items-center', isDynamicRegistration && 'opacity-50')}>
