...
import Drawer from '@/components/drawer-plus'
      ...
      <Drawer
        ...
        body={(
          <div className="flex h-full flex-col">
                        ...
                        <tr key={index} className="border-b border-divider-regular last:border-0">
                          ...
                          <td>
                            {item.name === '__image' && (
                              ...
                              >
                                <div className={clsx('grow truncate text-[13px] leading-[18px] text-text-secondary')}>
            ...
            <div className={clsx((!isAdd && onRemove) ? 'justify-between' : 'justify-end', 'mt-2 flex shrink-0 rounded-b-[10px] border-t border-divider-regular bg-background-section-burn px-6 py-4')}>
              {!isAdd && onRemove && (
