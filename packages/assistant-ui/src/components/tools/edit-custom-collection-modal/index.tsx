      ...
      <Drawer
        ...
        body={(
          <div className="flex h-full flex-col">
                ...
                <div className="w-full overflow-x-auto rounded-lg border border-divider-regular">
                  <table className="system-xs-regular w-full text-text-secondary">
                    <thead className="uppercase text-text-tertiary">
                      <tr className={clsx(paramsSchemas.length > 0 && 'border-b', 'border-divider-regular')}>
            ...
            <div className={clsx(isEdit ? 'justify-between' : 'justify-end', 'mt-2 flex shrink-0 rounded-b-[10px] border-t border-divider-regular bg-background-section-burn px-6 py-4')}>
              {
                isEdit && (
