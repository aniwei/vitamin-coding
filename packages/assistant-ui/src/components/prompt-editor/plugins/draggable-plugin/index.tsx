  ...
  return (
    <DraggableBlockPlugin_EXPERIMENTAL
      ...
      menuComponent={
        isSupportDrag
          ? (
              <div ref={menuRef} className={clsx(DRAGGABLE_BLOCK_MENU_CLASSNAME, 'absolute right-2.5 top-4 cursor-grab opacity-0 will-change-transform active:cursor-move')} data-testid="draggable-menu">
