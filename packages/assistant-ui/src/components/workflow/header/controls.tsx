import { 
  ...
  StepOver,
  Step,
} from '@/components/icons/devtools'
...
const Controls: React.FC<ControlsProps> = memo(({
  ...
  return (
    <div className="flex h-8 items-center rounded-lg border-[0.5px] border-components-button-secondary-border bg-components-button-secondary-bg px-0.5 shadow-xs">
      ...
      <Control icon={<Pause className="h-4 w-4" />} />
      <Control icon={<StepOver className="h-4 w-4" />} />
      <Control icon={<StepInto className="h-4 w-4" />} />
      <Control icon={<StepOut className="h-4 w-4" />} />
      <Control icon={<Step className="h-4 w-4" />} />
      <Control icon={<BreakpointCrossed className="h-4 w-4" />} />
      <Control icon={<BreakpointCrossedFilled className="h-4 w-4" />} />
