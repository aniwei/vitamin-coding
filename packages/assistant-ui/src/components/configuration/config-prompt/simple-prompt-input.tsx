...
import PromptEditorHeightResize from './prompt-editor-height-resize'

type SimplePromptInput = {
  mode: AppModeEnum
...
export const Prompt: FC<SimplePromptInput> = ({
  mode,
  promptTemplate,
  promptVariables,
  readonly = false,
  ...
  return (
    <div className={clsx('relative rounded-xl bg-linear-to-r from-components-input-border-active-prompt-1 to-components-input-border-active-prompt-2 p-0.5 shadow-xs')}>
      <div className="rounded-xl bg-background-section-burn">
        ...
        <PromptEditorHeightResizeControl
