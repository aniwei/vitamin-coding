...
import { resetUser } from '@/components/amplitude/utils'
  ...
  return (
    <div>
      <DropdownMenu open={isAccountMenuOpen} onOpenChange={setIsAccountMenuOpen}>
        <DropdownMenuTrigger
          aria-label="Account"
          className={clsx('inline-flex items-center radius-3xl p-0.5 hover:bg-background-default-dodge', isAccountMenuOpen && 'bg-background-default-dodge')}
        >
