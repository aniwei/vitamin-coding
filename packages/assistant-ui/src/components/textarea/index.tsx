...
export interface TextareaProps extends React.TextareaHTMLAttributes<HTMLTextAreaElement>, VariantProps<typeof tv> {
  value: string | number
  disabled?: boolean
  destructive?: boolean
  style?: CSSProperties
...
export const Textarea: React.FC<TextareaProps> = React.forwardRef<HTMLTextAreaElement, TextareaProps>(({ className, value, onChange, disabled, size, destructive, style, onFocus, onBlur, ...props }, ref) => {
  return (
    <textarea
      ref={ref}
      onFocus={onFocus}
