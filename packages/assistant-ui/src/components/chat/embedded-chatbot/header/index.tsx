...
import ViewFormDropdown from '@/components/chat/embedded-chatbot/inputs-form/view-form-dropdown'
...
const Header: FC<IHeaderProps> = ({
  ...
  return (
    <div
      className={clsx('flex h-14 shrink-0 items-center justify-between rounded-t-2xl px-3')}
          ...
          showToggleExpandButton && (
            ...
            >
              <ActionButton size="l" onClick={handleToggleExpand} data-testid="mobile-expand-button">
                {
                  expanded
                    ? <div className={clsx('i-ri-collapse-diagonal-2-line h-[18px] w-[18px]', theme?.colorPathOnHeader)} />
                    : <div className={clsx('i-ri-expand-diagonal-2-line h-[18px] w-[18px]', theme?.colorPathOnHeader)} />
                }
              </ActionButton>
            </Tooltip>
          )
        ...
        {currentConversationId && allowResetChat && (
          ...
          >
            <ActionButton size="l" onClick={onCreateNewChat} data-testid="mobile-reset-chat-button">
              <div className={clsx('i-ri-reset-left-line h-[18px] w-[18px]', theme?.colorPathOnHeader)} />
            </ActionButton>
          </Tooltip>
        )}
        {currentConversationId && inputsForms.length > 0 && !allInputsHidden && (
