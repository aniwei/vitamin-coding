...
import ChatWrapper from '@/components/chat/embedded-chatbot/chat-wrapper'
import Header from '@/components/chat/embedded-chatbot/header'
import Loading from '@/components/loading'
import DifyLogo from '@/components/logo/dify-logo'
import LogoHeader from '@/components/logo/logo-embedded-chat-header'
  ...
  return (
    <div className="relative">
      ...
      >
        ...
        />
        <div className={clsx('flex grow flex-col overflow-y-auto', isMobile && 'm-[0.5px] h-[calc(100vh-3rem)]! rounded-2xl bg-chatbot-bg')}>
          {appChatListDataLoading && (
            <Loading type="app" />
          )}
          {!appChatListDataLoading && (
