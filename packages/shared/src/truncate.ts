...
export function truncateHead(content: string, options: TruncateOptions): TruncatedResult {
...
export function truncateTail(content: string, options: TruncateOptions): TruncatedResult {
  const { maxLines, maxBytes } = options
