...
export const VitaminSettingStrictSchema = z.object({
...
export const VitaminSettingSchema = z.looseObject(VitaminSettingStrictSchema.shape)


export type VitaminSettingFromSchema = z.infer<typeof VitaminSettingSchema>
