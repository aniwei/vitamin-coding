...
export type AgentRepository = {
  ...
  updateAgent(id: string, userId: string, agent: z.infer<typeof AgentUpdateSchema>): Promise<Agent>
  ...
  checkAccess(agentId: string, userId: string, destructive?: boolean): Promise<boolean>
}
...
export const AgentGenerateSchema = z.object({
  ...
  tools: z.array(z.string()).describe('Agent allowed tools name').optional().default([]),
})
