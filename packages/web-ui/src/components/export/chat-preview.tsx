import { ChatExportCommentWithUser, ChatExportWithUser } from 'app-types/chat-export'
...
export default function ChatPreview({
  ...
  return (
    <div className='flex flex-col min-w-0 h-full relative' data-testid='export-preview'>
              ...
              <TooltipTrigger asChild>
                <div className='flex items-center gap-2 text-xs'>
                  <Avatar className='size-4 rounded-full'>
                    ...
                    <AvatarFallback>{thread.exporterName?.[0]?.toUpperCase()}</AvatarFallback>
                  </Avatar>
                </div>
              </TooltipTrigger>
