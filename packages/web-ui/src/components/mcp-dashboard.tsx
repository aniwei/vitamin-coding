      ...
      <ScrollArea className='h-full w-full z-40 '>
        <div className='pt-8 flex-1 relative flex flex-col gap-4 px-8 max-w-3xl h-full mx-auto pb-8'>
          ...
          {isLoading ? (
            ...
            <div className='flex flex-col gap-8 mb-4' data-testid='mcp-servers-section'>
              {myServers?.length > 0 && (
                <div className='flex flex-col gap-4'>
                  <h2 className='text-lg font-semibold text-muted-foreground'>
                    {t('myMcpServers')}
                  </h2>
                  <div className='flex flex-col gap-6' data-testid='my-mcp-servers-section'>
                    {myServers.map((mcp) => (
              ...
              {featuredServers?.length > 0 && (
                <div className='flex flex-col gap-4'>
                  ...
                  <div className='flex flex-col gap-6' data-testid='featured-mcp-servers-section'>
          ...
          canCreate ? (
            ...
            <div className='flex flex-col items-center justify-center space-y-4 my-20 text-center'>
              <h3 className='text-2xl md:text-4xl font-semibold'>{t('noMcpServersAvailable')}</h3>
