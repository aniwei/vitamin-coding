  ...
  return (
    <div className='space-y-4 w-full'>
      <div className='flex items-center gap-4'>
        ...
        <div className='text-sm text-muted-foreground' data-testid='users-total-count'>
            ...
            {users.length === 0 ? (
              ...
              users.map((user) => (
                ...
                >
                  ...
                  <TableCell>
                    <UserRoleBadges user={{ ...user }} showBanned={false} className='mt-0' />
                  </TableCell>
                  <TableCell>
                    <UserStatusBadge
      ...
      <TablePagination currentPage={page} totalPages={totalPages} buildUrl={buildUrl} />
    </div>
  )
}
