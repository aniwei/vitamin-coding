    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className='xl:max-w-[40vw] w-full max-w-full'>
        <DialogHeader>
          ...
          <DialogDescription className='sr-only'>Generate Agent</DialogDescription>
        </DialogHeader>
        <div className='flex flex-col gap-6 w-full'>
          ...
          <div className='relative flex flex-col border rounded-lg p-4'>
            ...
            <div className='flex justify-end items-center gap-2'>
              <SelectModel showProvider onSelect={(model) => setGenerateModel(model)} />
              <Button
                ...
                className='text-xs'
              >
                <span className='mr-1'>{isLoading ? 'Generating...' : 'Send'}</span>
                {isLoading ? (
