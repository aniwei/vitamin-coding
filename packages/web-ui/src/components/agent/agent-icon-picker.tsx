...
export function AgentIconPicker({ icon, disabled = false, onChange }: AgentIconPickerProps) {
      ...
      <DropdownMenuTrigger asChild disabled={disabled}>
        ...
        >
          <Avatar className='size-10'>
            <AvatarImage src={icon?.value} className='group-hover:scale-110 transition-transform' />
