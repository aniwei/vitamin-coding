...
function PureImageGeneratorToolInvocation({ part }: ImageGeneratorToolInvocationProps) {
...
export const ImageGeneratorToolInvocation = memo(PureImageGeneratorToolInvocation, (prev, next) => {
