          ...
          >
            ...
            >
              <div className='border rounded overflow-hidden'>
                <NodeIcon type={item.kind} iconClassName='size-3' className='rounded-none' />
              </div>
              {item.status == 'running' ? (
              ...
              <span
                className={cn('ml-auto text-xs', item.status != 'fail' && 'text-muted-foreground')}
              >
...
function areEqual(prev: WorkflowInvocationProps, next: WorkflowInvocationProps) {
