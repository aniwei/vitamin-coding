    ...
    <Card className='transition-all duration-200 hover:shadow-md'>
      ...
      <CardContent className='h-full'>
        <form action={detailsUpdateFormAction} className='space-y-6 h-full flex flex-col'>
            ...
            <div className='space-y-2'>
              ...
              <Tooltip>
                <TooltipTrigger asChild>
                  <span
                    className={
                      !!userAccountInfo?.oauthProviders?.length ? 'cursor-not-allowed' : ''
                    }
                  >
                    <Input
                      id='email'
                      ...
                      disabled={!!userAccountInfo?.oauthProviders?.length || isPending}
                      required
                ...
                {!!userAccountInfo?.oauthProviders?.length && (
                  <TooltipContent>{t('emailCannotBeModifiedSSO')}</TooltipContent>
                )}
              </Tooltip>
            </div>
          </div>
          ...
          {/* Save Button */}
          <div className='mt-4'>
            <SubmitButton className='w-full' data-testid='save-changes-button' disabled={isPending}>
