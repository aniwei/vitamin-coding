      ...
      <CardContent className='space-y-4'>
        {!hasActivity ? (
          ...
          <div className='text-center py-12' data-testid='no-activity-state'>
            ...
            <h3 className='text-lg font-semibold mb-2'>{tCommon('noAiActivityYet')}</h3>
            <p className='text-sm text-muted-foreground mb-4'>{t('noAiActivityDescription')}</p>
            <p className='text-xs text-muted-foreground'>{t('usageStatsWillAppear')}</p>
          </div>
        ) : (
          <>
            {/* Main Stats Grid */}
            <div className='grid gap-4 sm:grid-cols-4' data-testid='stats-grid'>
              ...
              >
                <div className='flex items-center gap-3'>
                  ...
                  <div>
                    ...
                    <p className='text-xl font-bold' data-testid='stat-total-tokens'>
              ...
              {/* Models Used */}
              <div className='rounded-lg border p-3 bg-muted/30' data-testid='models-used-stat'>
                <div className='flex items-center gap-3'>
                  ...
                  <div>
                    ...
                    <p className='text-xl font-bold' data-testid='stat-models-used'>
              ...
              {/* Messages */}
              <div className='rounded-lg border p-3 bg-muted/30' data-testid='messages-stat'>
                <div className='flex items-center gap-3'>
                  <div className='rounded-full p-2 bg-muted shrink-0'>
                  ...
                  <div>
                    ...
                    <p className='text-xl font-bold' data-testid='stat-messages-sent'>
                      {stats.messageCount}
                    </p>
                  </div>
                </div>
                      ...
                      {stats.modelStats.map((modelStat, index) => (
                        <div
                          ...
                          className={`flex items-center justify-between p-3 rounded-lg border hover:bg-background/70 transition-colors ${
                            index < 3 ? 'bg-primary/5 border-primary/20' : 'bg-background/50'
                          }`}
                        >
                          <div className='flex items-center gap-3 min-w-0 flex-1'>
                            ...
                            <div className='min-w-0 flex-1'>
                              <div className='text-sm font-medium truncate'>{modelStat.model}</div>
            ...
            <div className='grid gap-3 sm:grid-cols-3'>
              <div className='rounded-lg border bg-muted/30 p-3 text-center'>
                ...
                <p className='text-lg font-semibold' data-testid='stat-chat-threads'>
                  {stats.threadCount}
                </p>
              </div>
