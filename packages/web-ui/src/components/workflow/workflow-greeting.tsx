  ...
  return (
    <div className='space-y-6 w-full'>
      ...
      <div className='grid md:grid-cols-2 gap-8 items-start'>
        ...
        {/* Right: Node Grid */}
        <div className='space-y-4'>
          <h3 className='text-sm font-semibold'>{t('Workflow.greeting.availableNodesTitle')}</h3>
      ...
      <div className='text-center pt-4 border-t'>
        <p className='text-xs text-muted-foreground'>{t('Workflow.greeting.ctaMessage')}</p>
      </div>
    </div>
  )
}
