...
import { OutputSchemaSourceKey, UINode } from 'lib/ai/workflow/workflow.interface'
...
const outputSchemaMentionInputSuggestionBuilder = (
  ...
  memo(function OutputSchemaMentionInputSuggestion({ onSelectMention, top, left, onClose }) {
