          ...
          <div className='w-full h-full flex flex-col gap-2'>
            <div className='flex items-center relative'>
              ...
              <Button
                key='input'
                variant='ghost'
                className={cn('rounded-none', tab == 'input' && 'border-b border-primary')}
              ...
              <Button
                key='output'
                variant='ghost'
                className={cn('rounded-none', tab == 'output' && 'border-b border-primary')}
            ...
            <div className='flex flex-col gap-2 w-full p-4 pt-2 min-w-0'>
                ...
                <>
                  <Button
                    ...
                    onClick={() =>
                      copy(
                        JSON.stringify(
                          tab == 'input' ? history.result?.input : history.result?.output,
                        ),
                      )
                    }
                  >
              ...
              {tab == 'output' && history.status === 'fail' ? (
                ...
                <JsonView
                  ...
                  data={tab == 'input' ? history.result?.input : history.result?.output}
                />
              )}
            </div>
          </div>
