...
import { ToolNodeData, UINode, WorkflowToolKey } from 'lib/ai/workflow/workflow.interface'
...
export const ToolNodeDataConfig = memo(function ({ data }: { data: ToolNodeData }) {
  ...
  return (
    <div className='flex flex-col gap-2 text-sm px-4'>
      ...
      <WorkflowToolSelect
        ...
        tool={data.tool}
      />
      <p className='text-sm font-semibold my-2'>{t('Workflow.descriptionAndSchema')}</p>
