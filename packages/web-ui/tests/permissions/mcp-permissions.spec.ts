...
test.describe.serial('MCP Visibility - Admin Creates Private Server', () => {
  ...
  test("editor does NOT see admin's private server", async ({ browser }) => {
    ...
    const hasAdminServer = servers.some((s: any) => s.name === adminServerName)
...
test.describe.serial('MCP Visibility - Admin Features Server', () => {
...
test.describe.serial('MCP Visibility - Editor Creates Private Server', () => {
...
test.describe.serial('MCP Visibility - State Transitions', () => {
